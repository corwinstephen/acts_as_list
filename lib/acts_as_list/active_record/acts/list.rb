    ...
    module List #:nodoc:
      ...
      module ClassMethods
        ...
        def acts_as_list(options = {})
          configuration = { column: "position", scope: "1 = 1", top_of_list: 1, add_new_at: :bottom, touch_on_update: true, ignore_sti: false }
          ...
          ActiveRecord::Acts::List::AuxMethodDefiner.call(caller_class, configuration[:ignore_sti] )
